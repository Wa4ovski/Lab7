...
public class Updater {
    ...
    public static long updateSalary() {
        while (true) {
            ...
            try {
                long salary = Parsers.parseTheId(data);
                return salary;
    ...
    public static LocalDateTime updateStartDate(){
        while (true){
            ...
            try {
                LocalDateTime startDate = Parsers.parseTheLocalDateTime(data);
                return startDate;
            }  catch (DomainViolationException e) {
             e.printMessage();
           }//!!!
    ...
    public static Date updateEndDate(){
        while (true){
            ...
            try {
                Date endDate = Parsers.parseTheDate(data);
                return endDate;
            } catch (DomainViolationException e) {
                e.printMessage();
            }//!!!
    ...
    public static LocalDateTime updateBirthday(){
        while (true){
            ...
            try {
                LocalDateTime birthday = Parsers.parseTheLocalDateTime(data);
                return birthday;
            } catch (DomainViolationException e) {
                e.printMessage();
            }//!!!
    ...
    public static int updateHeight() {
        while (true) {
            ...
            try {
                int height = Parsers.parseTheHeigth(data);
                return height;
            } catch (DomainViolationException e) {
                e.printMessage();
            } catch (NumberFormatException e) {
